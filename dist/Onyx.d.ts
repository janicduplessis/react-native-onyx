...
import type { AnyComputedKey, Collection, CollectionKeyBase, ConnectOptions, InitOptions, KeyValueMapping, Mapping, NullableKeyValueMapping, NullishDeep, OnyxEntry, OnyxKey, OnyxUpdate } from './types';
 ...
 */
declare function connect<TKey extends OnyxKey | AnyComputedKey>(mapping: ConnectOptions<TKey>): number;
/**
