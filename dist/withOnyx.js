        ...
        class withOnyx extends react_1.default.Component {
            ...
            componentDidUpdate(prevProps, prevState) {
                ...
                underscore_1.default.each(mapOnyxToState, (mapping, propName) => {
                    ...
                    const previousKey = OnyxUtils_1.default.getCacheKey(isFirstTimeUpdatingAfterLoading ? mapping.previousKey : Str.result(mapping.key, Object.assign(Object.assign({}, prevProps), prevOnyxDataFromState)));
                    const newKey = OnyxUtils_1.default.getCacheKey(Str.result(mapping.key, Object.assign(Object.assign({}, this.props), onyxDataFromState)));
